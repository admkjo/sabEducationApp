...
import com.sabonay.education.sms.processsors.StudentStatusProcessor;
 ...
 * @author Edwin
 */
public class StudentStatusAssembler extends EasyAssembler {
...
//        String msg = "edu presec '8511' status";
        ...
        try {
            ...
            //String response = StudentStatusProcessor.studentStatus(studentId, userData);
