...
public class StudentBillPaymentInfo implements Serializable {
    ...
    private List<StudentLedger> studentTermLedgerEntryList = new ArrayList<StudentLedger>();
    ...
    public void prepareStudentInfo(String studentId, UserData userData) {
    ...
    public void prepareStudentInfo(Student student, UserData userData) {
        this.userData = userData;
...
//        System.out.println("THE TOTAL OUTSTANDING  IS " + outstandingBalance);
    ...
    private void doSingleCal() {
        System.out.println("THE STUDENT TERM LEDGER ENTRY LIST SIZE IS " + studentTermLedgerEntryList.size());

        for (StudentLedger studentLedger : studentTermLedgerEntryList) {
//            System.out.println("??????????????????????? " +studentLedger.getAmountInvolved());
...
//            System.out.println("THE AMOUNT INVOLVED IS " + studentLedger.getAmountInvolved());
            System.out.println("Break Checker " + studentLedger.getStudent());
...
//                        System.out.println("THE TOTAL CREDIT HOURSE DUES FEES IS " + totalCreditHouseDues);
                        ...
                        totalCreditHouseDues = totalCreditHouseDues + studentLedger.getAmountInvolved();
//                        System.out.println("THE TOTAL CREDIT HOUSE DUES FEES IS " + totalCreditHouseDues);
                    }
...
//                        System.out.println("THE TOTAL HOURSE DEBIT FEES IS " + totalDebitPTA);
                    } else if (studentLedger.getStudentBillType().getStudentBillTypeId().equalsIgnoreCase("SD")) {
                        totalDebitHouseDues = totalDebitHouseDues + studentLedger.getAmountInvolved();
//                        System.out.println("THE TOTAL HOURSE DEBIT FEES IS " + totalDebitPTA);
                    }
