 ...
 */
@Entity
@Table(name = "mid_term_mark_sms")
public class MidtermMarksSms implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MidtermMarksSms)) {
            return false;
        }
        MidtermMarksSms other = (MidtermMarksSms) object;
    ...
    public String toString() {
        return "com.sabonay.education.ejb.entities.MidtermMarksSms[ id=" + smsMarkId + " ]";
    }
}
